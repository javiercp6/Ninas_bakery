<template>
  <section class="text-gray-600 body-font overflow-hidden">
    <div class="container px-5 mx-auto">
      <div class="lg:w-4/5 mx-auto flex flex-wrap h-72">
        <div
          class="flex items-center justify-center lg:h-auto h-64 bg-gray-300 lg:w-1/2 w-full dark:bg-gray-700 object-cover object-center rounded-lg"
        >
          <svg
